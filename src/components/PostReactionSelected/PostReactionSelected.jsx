  ...
  const postReactedSetup = () => {
    switch (postReacted) {
      case "like":
        return (
          <div className="post__reaction_panel">
            <img src="\assets\images\icons\like-reaction.png" alt="" />
      ...
      case "love":
        return (
          <div className="post__reaction_panel">
            <img src="\assets\images\icons\love-reaction.png" alt="" />
      ...
      case "care":
        return (
          <div className="post__reaction_panel">
            <img src="\assets\images\icons\care-reaction.png" alt="" />
      ...
      case "haha":
        return (
          <div className="post__reaction_panel">
            <img src="\assets\images\icons\haha-reaction.png" alt="" />
      ...
      case "wow":
        return (
          <div className="post__reaction_panel">
            <img src="\assets\images\icons\wow-reaction.png" alt="" />
      ...
      case "sad":
        return (
          <div className="post__reaction_panel">
            <img src="\assets\images\icons\sad-reaction.png" alt="" />
      ...
      case "angry":
        return (
          <div className="post__reaction_panel">
            <img src="\assets\images\icons\angry-reaction.png" alt="" />
